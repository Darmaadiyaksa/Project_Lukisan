...
<section class="relative z-10 overflow-hidden bg-blue py-20 lg:py-[120px]">
        ...
        <div class="mb-12 max-w-[570px] lg:mb-0">
         ...
         Damping Gallery
          ...
          <p class="text-body-color mb-9 text-base leading-relaxed">
            Apa bila teman-teman ada kendala atau masalah teman teman bisa hubungin contak di bawah ini atau ada keluhan teman-teman bisa isi keluhan teman teman di samping.
          </p>
          ...
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              <h4 class="text-dark mb-1 text-xl font-bold">Nomor Telepon</h4>
              <p class="text-body-color text-base">(0361)96473</p>
            </div>
          </div>
          <div class="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div class="w-full">
              ...
              <p class="text-body-color text-base">info@dampinggallery.com</p>
            </div>
          </div>
        </div>
      </div>
